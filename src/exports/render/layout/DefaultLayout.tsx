      ...
      <div className='absolute bottom-0 left-0 flex w-full items-center justify-center gap-3 pt-2 text-sm bg-black/20'>
            ...
            <div className='flex items-center gap-2'>
              ...
              <div className='flex flex-col'>
                ...
                <div className={`flex ${mysPlugin.version.length > 8 ? 'flex-col' : 'items-baseline gap-0.5'}`}>
                  ...
                  <strong className='text-[8px] font-bold text-[#f2c06f]'>v{mysPlugin.version}</strong>
                </div>
              </div>
            </div>
        ...
        <div className='flex items-center gap-2'>
          ...
          <div className='flex flex-col'>
            ...
            <div className={`flex ${dir.version.length > 8 ? 'flex-col' : 'items-baseline gap-0.5'}`}>
              ...
              <strong className='text-[8px] font-bold text-[#f2c06f]'>v{dir.version}</strong>
            </div>
          </div>
        </div>
        ...
        <div className='flex items-center gap-2'>
          ...
          <div className='flex flex-col'>
            ...
            <div className={`flex ${karinVersion.length > 8 ? 'flex-col' : 'items-baseline gap-0.5'}`}>
              <span className='font-semibold'>Karin</span>
              <strong className='text-[8px] font-bold text-[#f2c06f]'>v{karinVersion}</strong>
            </div>
          </div>
        </div>
      </div>
