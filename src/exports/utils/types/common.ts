...
// 辅助类型:至少 N 个元素的数组
type MinLength<T, N extends number> = [...Tuple<T, N>, ...T[]]

export interface DefineDataTypeObject<V extends Record<string, any>, MinReq extends number = 0> {
  ...
  required?: V extends Record<string, any> ? MinLength<Extract<keyof V, string>, MinReq> : never
}
